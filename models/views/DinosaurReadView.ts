...
export class DinosaurReadView extends Dinosaur{
    ...
    constructor(dinosaurId: number|null,
        ...
        super(dinosaurId, dinosaurName, dinosaurDiet, dinosaurDescription, dinosaurSpecies, dinosaurVisitable)
    }

    static fromRow(row: DinosaurTypeRow): DinosaurReadView {
        return new DinosaurReadView(row.dinosaur_id, row.dinosaur_name, row.dinosaur_diet, row.dinosaur_description, row.dinosaur_species, row.dinosaur_visitable)
    }
